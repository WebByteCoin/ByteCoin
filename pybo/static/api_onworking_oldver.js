...
function loading() {
    ...
    $.getJSON('https://api.bithumb.com/public/ticker/BTC_KRW', function(data) {
        ...
        text = formating_kr(text);
        text11 = formating_kr(text11);
        text12 = formating_kr(text12);
        text = text + " (종가)<br>" + text11 + "/" + text12;
        $(".bth_pbtc").html(text);
    });
    ...
    $.getJSON('https://poloniex.com/public?command=returnTicker', function(data) {
        ...
        text1 = text1 + " (종가)<br>" + text11 + "/" + text12;
        ...
        text2 = text2 + " (종가)<br>" + text21 + "/" + text22;
        ...
        text3 = text3 + " (종가)<br>" + text31 + "/" + text32;
        ...
        text4 = text4 + " (종가)<br>" + text41 + "/" + text42;
        ...
        text5 = text5 + " (종가)<br>" + text51 + "/" + text52;
        ...
        text6 = text6 + " (종가)<br>" + text61 + "/" + text62;
        ...
        text7 = text7 + " (종가)<br>" + text71 + "/" + text72;
